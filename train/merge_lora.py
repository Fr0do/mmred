...
def main():
    ...
    parser.add_argument("--config_path", type=str, default=None, required=False, help="Path to the config of base model.")
    ...
    if args.config_path:
        ...
        model = AutoModelForCausalLM.from_pretrained(args.lora_path, device_map="cpu", dtype=torch.bfloat16)
    peft_model = PeftModelForCausalLM.from_pretrained(model, args.lora_path, device_map="cpu", dtype=torch.bfloat16)
