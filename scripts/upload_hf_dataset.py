...
# 5 Russian prompts for MERA evaluation (must match raw_dataset_meta.json)
PROMPTS = [
    "Вы анализируете последовательность состояний комнат, где указано, какие персонажи находятся в каких комнатах на каждом шаге.\n\n{context}\n\nВопрос: {question}\n\nОтветьте одним словом или числом.",
    "Изучите описание расположения персонажей в комнатах.\n\n{context}\n\nНа основе этой информации ответьте на вопрос.\n{question}\n\nУкажите ответ одним словом или числом.",
    "Ниже представлена последовательность шагов. На каждом шаге указано, кто в какой комнате находится.\n\n{context}\n\n{question}\nОтвет (одно слово или число):",
    "Прочитайте описание перемещений персонажей по комнатам и ответьте на вопрос.\n\n{context}\n\nВопрос: {question}\nНапишите только ответ — одно слово или число.",
    "Вам дана последовательность шагов с расположением персонажей в комнатах. Внимательно проанализируйте данные и ответьте.\n\n{context}\n\n{question}\nОтвет:",
]
